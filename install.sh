...
Joiner:add_repo "hw-core/js-lib-common"       "js-lib-common"      "master" "$VENDOR",
Joiner:add_repo "hw-core/js-lib-filesystem",  "js-lib-filesystem"  "master" "$VENDOR"
Joiner:add_repo "hw-core/js-lib-browser-gui", "js-lib-browser-gui" "master" "$VENDOR"
